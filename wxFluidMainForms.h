...
class CMainFrame : public wxFrame
{
	...
	protected:
		...
		virtual void OnMenuConfigureAudio( wxCommandEvent& event ) { event.Skip(); }
...
class AboutDialog : public wxDialog
{
	...
	protected:
		...
		wxStaticText* rtmidicredit;
		wxStaticText* rtaudiocredit;
	...
	public:
		...
		AboutDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("About wxFluid..."), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 363,573 ), long style = wxDEFAULT_DIALOG_STYLE );
