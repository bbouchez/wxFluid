...
///////////////////////////////////////////////////////////////////////////////
/// Class CAudioConfigDialog
///////////////////////////////////////////////////////////////////////////////
class CAudioConfigDialog : public wxDialog
{
	private:
	...
	public:
		...
		CAudioConfigDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Audio Configuration"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 586,241 ), long style = wxDEFAULT_DIALOG_STYLE );
...
class CSynthConfigDialog : public wxDialog
{
	...
	public:
		...
		CSynthConfigDialog( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Synth Engine Configuration"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 456,180 ), long style = wxDEFAULT_DIALOG_STYLE );
