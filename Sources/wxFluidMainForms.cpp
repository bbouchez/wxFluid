...
CMainFrame::CMainFrame( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxMenuItem* MenuConfigureAudio;
	MenuConfigureAudio = new wxMenuItem( OptionsMenu, wxID_ANY, wxString( wxT("Audio Configuration") ) , wxEmptyString, wxITEM_NORMAL );
	OptionsMenu->Append( MenuConfigureAudio );
	...
	OptionsMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( CMainFrame::OnMenuConfigureAudio ), this, MenuConfigureAudio->GetId());
...
AboutDialog::AboutDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText6 = new wxStaticText( this, wxID_ANY, wxT("wxFluid is built with :"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText6->Wrap( -1 );
	sizer->Add( m_staticText6, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );

	wxcredit = new wxStaticText( this, wxID_ANY, wxT("- wxWidgets 3.2"), wxDefaultPosition, wxDefaultSize, 0 );
	wxcredit->Wrap( -1 );
	sizer->Add( wxcredit, 0, wxBOTTOM|wxALIGN_CENTER_HORIZONTAL, 5 );

	rtmidicredit = new wxStaticText( this, wxID_ANY, wxT("- RtMidi 6.0.0"), wxDefaultPosition, wxDefaultSize, 0 );
	rtmidicredit->Wrap( -1 );
	sizer->Add( rtmidicredit, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );

	rtaudiocredit = new wxStaticText( this, wxID_ANY, wxT("- RtAudio 6.0.1"), wxDefaultPosition, wxDefaultSize, 0 );
	rtaudiocredit->Wrap( -1 );
	sizer->Add( rtaudiocredit, 0, wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
